...
if __name__ == '__main__':
	...
	titleFont = pygame.font.Font("fonts/flappybird.ttf", 108)
	textFont = pygame.font.Font("fonts/smallfont.ttf", 18)
	...
	#this should be a function so we can call this again
	#def playerAttack():
	Damage = 0
	extraXP = 0.0
	...
	def aiAttack():
		aiChooser = random.randint(1, 3)
		playerChooser = random.randint(1, 3)
		Damage = 0
		extraXP = 0.0

		#AI NUMBER 1

		if (aiChooser == 1 and playerChooser == 1) and (AIplayerImg1 == warriorEnemyCharacter):
			Damage = warriorATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player1HP -= Damage
				aiPlayer1XP += Damage
				if(Damage > 10):
					extraXP = 0.2
					aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
			elif(Damage <= 0):
				extraXP = 0.5
				aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
		elif (aiChooser == 1 and playerChooser == 1) and (AIplayerImg1 == tankerEnemyCharacter):
			Damage = tankerATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player1HP -= Damage
				aiPlayer1XP += Damage
				if(Damage > 10):
				...
				extraXP = 0.5
				aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
		elif (aiChooser == 1 and playerChooser == 2) and (AIplayerImg1 == warriorEnemyCharacter):
			Damage = warriorATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player2HP -= Damage
				aiPlayer1XP += Damage
				if(Damage > 10):
				...
				extraXP = 0.5
				aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
		elif (aiChooser == 1 and playerChooser == 2) and (AIplayerImg1 == tankerEnemyCharacter):
			Damage = tankerATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player2HP -= Damage
				aiPlayer1XP += Damage
				if(Damage > 10):
				...
				extraXP = 0.5
				aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
		elif (aiChooser == 1 and playerChooser == 3) and (AIplayerImg1 == warriorEnemyCharacter) and (playerImg3 == warriorCharacter):
			Damage = warriorATKAI  - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer1XP += Damage
				...
				extraXP = 0.5
				aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
		elif (aiChooser == 1 and playerChooser == 3) and (AIplayerImg1 == tankerEnemyCharacter) and (playerImg3 == warriorCharacter):
			Damage = tankerATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer1XP += Damage
				...
				extraXP = 0.5
				aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
		elif (aiChooser == 1 and playerChooser == 3) and (AIplayerImg1 == warriorEnemyCharacter) and (playerImg3 == tankerCharacter):
			Damage = warriorATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer1XP += Damage
				...
				extraXP = 0.5
				aiPlayer1XP = (aiPlayer1XP * extraXP) + aiPlayer1XP
		elif (aiChooser == 1 and playerChooser == 3) and (AIplayerImg1 == tankerEnemyCharacter) and (playerImg3 == tankerCharacter):
			Damage = tankerATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer1XP += Damage
		...
		if (aiChooser == 2 and playerChooser == 1) and (AIplayerImg2 == warriorEnemyCharacter):
			Damage = warriorATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player1HP -= Damage
				aiPlayer2XP += Damage
				if(Damage > 10):
					extraXP = 0.2
					aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
				elif(Damage <= 0):
					extraXP = 0.5
					aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
		elif (aiChooser == 2 and playerChooser == 1) and (AIplayerImg2 == tankerEnemyCharacter):
			Damage = tankerATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player1HP -= Damage
				aiPlayer2XP += Damage
		...
		elif (aiChooser == 2 and playerChooser == 2) and (AIplayerImg2 == warriorEnemyCharacter):
			Damage = warriorATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player2HP -= Damage
				aiPlayer2XP += Damage
				...
				extraXP = 0.5
				aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
		elif (aiChooser == 2 and playerChooser == 2) and (AIplayerImg2 == tankerEnemyCharacter):
			Damage = tankerATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player2HP -= Damage
				aiPlayer2XP += Damage
				...
				extraXP = 0.5
				aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
		elif (aiChooser == 2 and playerChooser == 3) and (AIplayerImg2 == warriorEnemyCharacter) and (playerImg3 == warriorCharacter):
			Damage = warriorATKAI  - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer2XP += Damage
				...
				extraXP = 0.5
				aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
		elif (aiChooser == 2 and playerChooser == 3) and (AIplayerImg2 == tankerEnemyCharacter) and (playerImg3 == warriorCharacter):
			Damage = tankerATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer2XP += Damage
				...
				extraXP = 0.5
				aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
		elif (aiChooser == 2 and playerChooser == 3) and (AIplayerImg2 == warriorEnemyCharacter) and (playerImg3 == tankerCharacter):
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer2XP += Damage
				if(Damage > 10):
				...
				extraXP = 0.5
				aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
		elif (aiChooser == 2 and playerChooser == 3) and (AIplayerImg2 == tankerEnemyCharacter) and (playerImg3 == tankerCharacter):
			Damage = tankerATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer2XP += Damage
				if(Damage > 10):
					extraXP = 0.2
					aiPlayer2XP = (aiPlayer2XP * aiPlayer2XP) + aiPlayer2XP
			elif(Damage <= 0):
				extraXP = 0.5
				aiPlayer2XP = (aiPlayer2XP * extraXP) + aiPlayer2XP
		...
		if (aiChooser == 3 and playerChooser == 1) and (AIplayerImg3 == warriorEnemyCharacter):
			Damage = warriorATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player1HP -= Damage
				aiPlayer3XP += Damage
				if(Damage > 10):
					extraXP = 0.2
					aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
			elif(Damage <= 0):
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
		elif (aiChooser == 3 and playerChooser == 1) and (AIplayerImg3 == tankerEnemyCharacter):
			Damage = tankerATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player1HP -= Damage
				aiPlayer3XP += Damage
				...
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
		elif (aiChooser == 3 and playerChooser == 2) and (AIplayerImg3 == warriorEnemyCharacter):
			Damage = warriorATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player2HP -= Damage
				aiPlayer3XP += Damage
				...
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
		elif (aiChooser == 3 and playerChooser == 2) and (AIplayerImg3 == tankerEnemyCharacter):
			Damage = tankerATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player2HP -= Damage
				aiPlayer3XP += Damage
				...
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
		elif (aiChooser == 3 and playerChooser == 3) and (AIplayerImg3 == warriorEnemyCharacter) and (playerImg3 == warriorCharacter):
			Damage = warriorATKAI  - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer3XP += Damage
				...
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
		elif (aiChooser == 3 and playerChooser == 3) and (AIplayerImg3 == tankerEnemyCharacter) and (playerImg3 == warriorCharacter):
			Damage = tankerATKAI - warriorDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer3XP += Damage
				...
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
		elif (aiChooser == 3 and playerChooser == 3) and (AIplayerImg3 == warriorEnemyCharacter) and (playerImg3 == tankerCharacter):
			Damage = warriorATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer3XP += Damage
				...
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP
		elif (aiChooser == 3 and playerChooser == 3) and (AIplayerImg3 == tankerEnemyCharacter) and (playerImg3 == tankerCharacter):
			Damage = tankerATKAI - tankerDEF + random.randint(-5, 10)
			if(Damage > 0):
				player3HP -= Damage
				aiPlayer3XP += Damage
				if(Damage > 10):
					extraXP = 0.2
					aiPlayer3XP = (aiPlayer3XP * aiPlayer3XP) + aiPlayer3XP
			elif(Damage <= 0):
				extraXP = 0.5
				aiPlayer3XP = (aiPlayer3XP * extraXP) + aiPlayer3XP

	#we should use functions, but im confused since global variables apparently dont work properly? problem was on aiPlayer3HP on playerAttack()
	...
	#TODO:
	#1. Do a while loop here to check if any of the players in the opposing team/player team is dead.
	#   If one is dead, repeat choosing process, then run playerAttack and aiAttack process again.
	#2. Create choosing team/enemies as a function.
	#3. Gamelog and Eventlog
	#4. Save, and Load game (if possible).
	#5. Put proper comments in all the codes, and make the code neater. Such as making seperate files etc.
	...
	if aiPlayer1XP == 100:
		aiPlayer1Rank += 1
		aiPlayer1XP = 0
	elif aiPlayer2XP == 100:
		aiPlayer2Rank += 1
		aiPlayer2XP = 0
	elif aiPlayer3XP == 100:
		aiPlayer3Rank += 1
		aiPlayer3XP = 0

	#testing purposes
	print("Player 1 HP: ", player1HP)
	print("AI Player 1 HP: ", aiPlayer1HP)
	print("Damage done: ", Damage)
	print("Player 1 XP: ", player1XP)
